...
*/
  ...
  var Ba,
    Ca = "undefined" !== typeof TextDecoder,
    Da,
    Ea = "undefined" !== typeof TextEncoder;
  function Fa(a) {
  ...
  function Qa(a) {
    ...
    if (a.constructor === Na) {
      if (null == a.g) var b = Ma || (Ma = new Uint8Array(0));
        ...
        var c = a.g;
        c =
          null == c || (La && null != c && c instanceof Uint8Array)
            ? c
            : "string" === typeof c
            ? Ja(c)
            : null;
  ...
  function Va(a) {
    ...
    b = this.m;
    Ta.length
      ? ((c = Ta.pop()), b && (c.u = b.u), a && Sa(c, a), (a = c))
      : (a = new Ra(a, b));
    this.g = a;
    this.l = this.g.g;
    this.h = this.i = -1;
  ...
  function T(a, b, c) {
    ...
    if (c)
      for (b = 0; b < c.length; b++)
        (a = c[b]),
          a < this.l
            ? ((a += this.j), (d = this.g[a]) ? fb(d) : (this.g[a] = mb))
            : (nb(this), (d = this.h[a]) ? fb(d) : (this.h[a] = mb));
  }
  ...
  function ob(a, b, c) {
    ...
    e === mb
      ? ((e = fb([])), V(a, b, e, d))
      : c && Array.isArray(e) && eb(e) & 2 && ((e = e.slice()), V(a, b, e, d));
    return e;
  }
  function W(a, b, c) {
    a = U(a, b);
  ...
  function pb(a, b, c) {
    ...
    if (!d) {
      ...
      d = [];
      for (
        var g = Array.isArray(e) ? !!(eb(e) & 2) : !1, f = 0;
        f < e.length;
        f++
      )
        (d[f] = new b(e[f])), g && gb(d[f].g);
  ...
  function qb(a, b, c, d, e) {
    ...
    a = ob(a, b);
    void 0 != e
      ? (g.splice(e, 0, c), a.splice(e, 0, X(c)))
      : (g.push(c), a.push(X(c)));
  }
  ...
  function ub(a) {
    ...
    switch (a.length) {
      ...
      default:
        throw Error(
          "unsupported number of parameters, expected [2-4], got " + a.length
        );
    }
  }
  function vb(a, b, c) {
  ...
  function yb(a, b, c) {
    ...
    for (var d = a.g, e = 128, g = 0, f = (a = 0); 4 > f && 128 <= e; f++)
      (e = d.h[d.g++]), (g |= (e & 127) << (7 * f));
    128 <= e &&
      ((e = d.h[d.g++]), (g |= (e & 127) << 28), (a |= (e & 127) >> 4));
    if (128 <= e)
      for (f = 0; 5 > f && 128 <= e; f++)
        (e = d.h[d.g++]), (a |= (e & 127) << (7 * f + 3));
    if (128 > e) {
      d = g >>> 0;
      e = a >>> 0;
      if ((a = e & 2147483648))
  ...
  function Ab(a, b, c) {
    ...
    var g;
    if (Ca)
      (g = Ba) || (g = Ba = new TextDecoder("utf-8", { fatal: !1 })),
      ...
      for (var f = [], k = null, h, l, n; e < d; )
        (h = a[e++]),
          128 > h
            ...
            : f.push(65533),
          8192 <= f.length && ((k = Aa(k, f)), (f.length = 0));
      g = Aa(k, f);
    }
    V(b, c, g);
    return !0;
  ...
  function Ub(a, b) {
    ...
    if (null != c && null != c) {
      ...
      c &&
        ((e = ~e >>> 0),
        (g = (~g >>> 0) + 1),
        4294967295 < g && ((g = 0), e++, 4294967295 < e && (e = 0)));
      M = g;
      N = e;
      c = M;
      for (g = N; 0 < g || 127 < c; )
        Q(d, (c & 127) | 128), (c = ((c >>> 7) | (g << 25)) >>> 0), (g >>>= 7);
      Q(d, c);
    }
    tb(a, b);
  }
    ...
    return H(function (p) {
      switch (p.g) {
        ...
        case 2:
          ...
          if ("object" === typeof window)
            return (
              fc("createMediapipeSolutionsWasm", { locateFile: a.locateFile }),
              ...
              (l = Promise.all(
                ...
                return H(function (w) {
                  if (1 == w.g)
                    return (
                      (m = window.createMediapipeSolutionsWasm),
  ...
  x.setOptions = function (a, b) {
    ...
    if ((b = b || this.g.options)) {
      for (
        var d = [], e = [], g = {}, f = C(Object.keys(a)), k = f.next();
        !k.done;
        g = { K: g.K, L: g.L }, k = f.next()
      ) {
        var h = k.value;
        (h in this.j && this.j[h] === a[h]) ||
          ((this.j[h] = a[h]),
          (k = b[h]),
          void 0 !== k &&
            (k.onChange &&
                  ...
                  case "video":
                    ...
                    if (
                      ...
                      m instanceof HTMLImageElement
                        ? ((t = m.naturalWidth), (w = m.naturalHeight))
                        : ((t = m.width), (w = m.height));
    ...
    return H(function (v) {
      switch (v.g) {
        ...
        case 2:
          ...
          r = c[n];
          if ("string" === typeof r)
            return (t = d), (w = n), F(v, pc(a, n, b[r]), 14);
          p = b[r.stream];
  ...
  function mc(a, b) {
    ...
    g = a.h.PacketListener.implement({
      onResults: function (k) {
        ...
        var n = a.listeners[c];
        n &&
          (a.C = oc(a, h, b.outs).then(function (r) {
            r = n(r);
            for (var p = 0; p < b.wants.length; ++p) {
              var m = h[d[p]];
              "object" === typeof m &&
                m.hasOwnProperty &&
                m.hasOwnProperty("delete") &&
                m.delete();
            }
            r && (a.C = r);
          }));
    ...
    this.g = new ic({
      ...
      files: function (c) {
        return [
          ...
          { data: !0, url: qc(c.modelComplexity) },
        ];
      },
